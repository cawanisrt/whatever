...
local function handleFCommand(targetName)
	...
	-- ✅ Unanchor and make physics effective
	...
	-- ✅ Move above target and push into them
	botRoot.CFrame = targetRoot.CFrame + Vector3.new(0, 3, 0)
	botRoot.Velocity = Vector3.new(150, 150, 150) -- force motion
	startFling()
...
-- ✅ Detect Controller on Start or Join
